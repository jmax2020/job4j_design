...
insert into fauna(name, avg_age, discovery_date) values ('cat', 3650, '1745-01-01');
...
insert into fauna(name, avg_age, discovery_date) values ('fish_shark', 10000, '1500-01-01');
